 ...
 *
 * Source location: src/llvmbe/runtime/hb_llvmgtstd.c
 * Built on Windows: pre-shipped as lib/win/mingw64-rt/hb_llvmgtstd.o
 * Built on macOS:   compiled by src/llvmbe/Makefile -> lib/darwin/clang/hb_llvmgtstd.o
 */
